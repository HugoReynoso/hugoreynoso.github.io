...
export const portfolioCopy: Record<Locale, PortfolioCopy> = {
  it: {
    ...
    projects: {
      ...
      types: ["Web app", "Gioco", "Web app", "Gioco", "Gioco", "PWA", "PWA", "Utility", "Dati", "Fork"],
      previewAlts: ["Anteprima di TikTok Chat", "Anteprima del gioco Crownfall — Puzzle Rescue", "Anteprima di SpinWheel", "Anteprima del gioco Neon Bastion", "Anteprima del gioco Green Valley Guardians", "Anteprima del gioco Flag Streak", "Anteprima del gioco Logo Streak", "Anteprima di Find My Car", "", ""],
  ...
  en: {
    ...
    projects: {
      ...
      ], types: ["Web app", "Game", "Web app", "Game", "Game", "PWA", "PWA", "Utility", "Data", "Fork"], previewAlts: ["TikTok Chat preview", "Crownfall — Puzzle Rescue game preview", "SpinWheel preview", "Neon Bastion game preview", "Green Valley Guardians game preview", "Flag Streak game preview", "Logo Streak game preview", "Find My Car preview", "", ""], allRepositories: "View all repositories",
