...
export const portfolioCopy: Record<Locale, PortfolioCopy> = {
  ...
  en: {
    ...
    projects: {
      ...
      ], types: ["Game", "Web app", "Web app", "Game", "Game", "Utility", "Game", "Game", "PWA", "PWA", "Utility", "Data", "Fork"], previewAlts: ["CAPI: Shadow Missions game preview", "TikTok Chat preview", "TrovaBenzina.it preview", "Defend My Dog game preview", "Crownfall — Puzzle Rescue game preview", "SpinWheel preview", "Neon Bastion game preview", "Green Valley Guardians game preview", "Flag Streak game preview", "Logo Streak game preview", "Find My Car preview", "", ""], allRepositories: "View all projects",
  ...
  es: {
    ...
    projects: {
      ...
      ], types: ["Juego", "Aplicación web", "Aplicación web", "Juego", "Juego", "Utilidad", "Juego", "Juego", "PWA", "PWA", "Utilidad", "Datos", "Fork"], previewAlts: ["Vista previa del juego CAPI: Shadow Missions", "Vista previa de TikTok Chat", "Vista previa de TrovaBenzina.it", "Vista previa del juego Defend My Dog", "Vista previa del juego Crownfall — Puzzle Rescue", "Vista previa de SpinWheel", "Vista previa del juego Neon Bastion", "Vista previa del juego Green Valley Guardians", "Vista previa del juego Flag Streak", "Vista previa del juego Logo Streak", "Vista previa de Find My Car", "", ""], allRepositories: "Ver todos los proyectos",
