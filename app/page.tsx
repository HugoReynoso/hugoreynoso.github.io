  ...
  return (
    <main>
      ...
      <aside className="social-rail" aria-label="Profili social">
        ...
        <a href="https://www.linkedin.com/in/hugo-aldo-reynoso/" target="_blank" rel="noreferrer" aria-label="LinkedIn"><span className="social-icon" aria-hidden="true">in</span></a>
        <a href="https://github.com/HugoReynoso" target="_blank" rel="noreferrer" aria-label="GitHub"><span className="social-icon" aria-hidden="true">GH</span></a>
        <a href="https://www.instagram.com/hugoaldorey/" target="_blank" rel="noreferrer" aria-label="Instagram"><span className="social-icon instagram-icon" aria-hidden="true">◎</span></a>
      </aside>
